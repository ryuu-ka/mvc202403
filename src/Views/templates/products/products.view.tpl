...
<section class="grid">
  <div class="row">
    <form class="col-12 col-m-8" action="index.php?page=Products_Products" method="get">
  ...
  <table>
    <thead>
      <tr>
        ...
        <th>Estado</th>
        <th>Imagen</th>
        <th><a href="index.php?page=Products-ProductF&mode=INS">Nuevo</a></th>
      </tr>
    </thead>
    <tbody>
      {{foreach products}}
      <tr>
        <td>{{productId}}</td>
        <td> <a class="link" href="index.php?page=Products-ProductF&mode=DSP&producto_id={{productId}}">{{productDescription}}</a>
        </td>
        <td class="right">
          {{productPrice}}
        </td>
        ...
        <td class="right">
          <a href="index.php?page=Products-ProductF&mode=UPD&producto_id={{productId}}">Editar</a>
          &nbsp;
          <a href="index.php?page=Products-ProductF&mode=DEL&producto_id={{productId}}">Eliminar</a>
        </td>
      </tr>
      {{endfor products}}
    </tbody>
